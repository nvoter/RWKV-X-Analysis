...
from .evaluators import Evaluator, LangSmithEvaluator, OpenAIEvaluator, QwenEvaluator
from .providers import Anthropic, ModelProvider, OpenAI, Cohere, RWKVX
...
def get_model_to_test(args: CommandArgs) -> ModelProvider:
    ...
    match args.provider.lower():
        ...
        case "rwkvx":
            return RWKVX(model_name=args.model_name, model_path=f"models\{args.model_name}.pth")
        case _:
...
def get_evaluator(args: CommandArgs) -> Evaluator:
    ...
    match args.evaluator.lower():
        ...
        case "qwen":
            return QwenEvaluator(true_answer=args.needle)
        case _:
